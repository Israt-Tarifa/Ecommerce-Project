        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <?php
                    ...
                    <?php }
                    echo "           কষ্টের টাকায় হোক বিশ্বস্ত কেনাকাটা        "
                   
                    ?>
                    <!-- <h5>কষ্টের টাকায় হোক বিশ্বস্ত কেনাকাটা</h5>  -->
            </div>
...
<div id="header-menu" >
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <ul class="menu-list" style="background-color: rgba(7, 7, 109, 0.753); color: white">
                    <?php
                    $db = new Database();
