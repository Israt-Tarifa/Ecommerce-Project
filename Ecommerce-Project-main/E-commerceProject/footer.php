<div id="footer" style="background-color: rgb(18,18,62)">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <?php
            ...
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by <a href="https://ajij120386.github.io/AjijPortfolio/" target="_blank">Ajij</a></span>
            </div>
        </div>
    </div>
</div>
