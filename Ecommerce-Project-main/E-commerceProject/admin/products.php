                    ...
                    <tr>
                        ...
                        <td>
                            <?php  if($row['featured_image'] != ''){ ?>
                                <img src="../product-images/<?php echo $row['featured_image']; ?>" alt="<?php echo $row['featured_image']; ?>" width="50px" height="60px"/>
                            <?php }else{ ?>
                                <img src="images/index.png" alt="" width="50px" height="60px"/>
                            <?php } ?>
                        </td>
                        <td><?php
